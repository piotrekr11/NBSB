...
#ifndef INC_REGS_FSK_H_
#define INC_REGS_FSK_H_
...
#define REG_OPMODE                                  0x01
		#define REG_OPMODE_LONGRANGEMODE_Pos		7
		#define REG_OPMODE_LONGRANGEMODE_Mask		(BB1<<REG_OPMODE_LONGRANGEMODE_Pos)
		#define REG_OPMODE_MODULATIONTYPE_Pos		5
		#define REG_OPMODE_MODULATIONTYPE_Mask		(BB2<<REG_OPMODE_MODULATIONTYPE_Pos)
		#define REG_OPMODE_MODE_Pos					0
		#define REG_OPMODE_MODE_Mask				(BB3<<REG_OPMODE_MODE_Pos)
...
#define REG_SYNCCONFIG                              0x27
		#define REG_SYNCCONFIG_SYNCON_Pos			4
		#define REG_SYNCCONFIG_SYNCON_Mask			(BB1<<REG_SYNCCONFIG_SYNCON_Pos)
		#define REG_SYNCCONFIG_SYNCSIZE_Pos			0
		#define REG_SYNCCONFIG_SYNCSIZE_Mask		(BB3<<REG_SYNCCONFIG_SYNCSIZE_Pos)
...
#define REG_PACKETCONFIG1                           0x30
		#define REG_PACKETCONFIG1_PACKETFORMAT_Pos			7
		#define REG_PACKETCONFIG1_PACKETFORMAT_Mask			(BB1<<REG_PACKETCONFIG1_PACKETFORMAT_Pos)
		#define REG_PACKETCONFIG1_DCFREE_Pos				5
		#define REG_PACKETCONFIG1_DCFREE_Mask				(BB2<<REG_PACKETCONFIG1_DCFREE_Pos)
		#define REG_PACKETCONFIG1_CRCON_Pos					4
		#define REG_PACKETCONFIG1_CRCON_Mask				(BB1<<REG_PACKETCONFIG1_CRCON_Pos)
		#define REG_PACKETCONFIG1_CRCAUTOCLEAROFF_Pos		3
		#define REG_PACKETCONFIG1_CRCAUTOCLEAROFF_Mask		(BB1<<REG_PACKETCONFIG1_CRCAUTOCLEAROFF_Pos)
		#define REG_PACKETCONFIG1_ADDRESSFILTERING_Pos		1
		#define REG_PACKETCONFIG1_ADDRESSFILTERING_Mask		(BB2<<REG_PACKETCONFIG1_ADDRESSFILTERING_Pos)

#define REG_PACKETCONFIG2                           		0x31
//		#define REG_PACKETCONFIG2_UNUSED					"7"
//		#define REG_PACKETCONFIG2_DATAMODE					"6"
//		#define REG_PACKETCONFIG2_IOHOMEON					"5"
//		#define REG_PACKETCONFIG2_IOHOMEPOWERFRAME			"4"
//		#define REG_PACKETCONFIG2_BEACONON					"3"
		#define REG_PACKETCONFIG2_PAYLOADLENGTHMSB_Pos		0
		#define REG_PACKETCONFIG2_PAYLOADLENGTHMSB_Mask		(BB3<<REG_PACKETCONFIG2_PAYLOADLENGTHMSB_Pos)
...
#define REG_IRQFLAGS1                               0x3E
	#define  REG_IRQFLAGS1_RSSI_Pos							(3)
	#define  REG_IRQFLAGS1_RSSI_Mask						(BB1<<REG_IRQFLAGS1_RSSI_Pos)
	#define  REG_IRQFLAGS1_PREAMBLEDETECT_Pos				(1)
	#define  REG_IRQFLAGS1_PREAMBLEDETECT_Mask				(BB1<<REG_IRQFLAGS1_PREAMBLEDETECT_Pos)
#define REG_IRQFLAGS2                               0x3F
	#define  REG_IRQFLAGS2_FIFOOVERRUN_Pos					(4)
	#define  REG_IRQFLAGS2_FIFOOVERRUN_Mask					(BB1<<REG_IRQFLAGS2_FIFOOVERRUN_Pos)
// I/O settings
...
#define RF_PACONFIG_OUTPUTPOWER_MASK                0x70 //0xF0 SK, PaSelect to 0
